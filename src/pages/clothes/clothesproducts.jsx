    ...
    <Container sx={{ mb: "20px", pb: "20px", pt: "20px" }}>
      ...
      >
        ...
        <Box>
          ...
          >
            <ToggleButton value="All"> All Clothes</ToggleButton>
            <ToggleButton value="Men">Men Clothes</ToggleButton>
            <ToggleButton value="Women">Women Clothes</ToggleButton>
          </ToggleButtonGroup>
        </Box>
      </Stack>
      <Stack
